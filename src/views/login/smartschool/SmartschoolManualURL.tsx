  ...
  useEffect(() => {
    if (instanceURL === "" && !route.params?.url) {
      Clipboard.getStringAsync().then((clipboardContent) => {
        if (clipboardContent && clipboardContent.includes("smartschool.be")) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      {!keyboardOpen && (
        ...
        >
          <PapillonShineBubble
            message={
              !clipboardFound ?
                "Indique moi l'adresse URL Smartschool de ton établissement"
      ...
      >
        ...
        <ResponsiveTextInput
          keyboardType="url"
          autoCapitalize="none"
          placeholder="URL de l'instance Smartschool"
...
export default SmartschoolManualURL;
